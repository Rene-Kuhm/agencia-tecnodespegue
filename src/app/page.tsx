	...
	return (
		<div className="flex flex-col">
			...
			<section className="relative w-full py-20 md:py-32 lg:py-40 overflow-hidden">
				...
				/>
				<div
					className="absolute top-40 right-20 w-64 h-64 bg-pink-500/10 rounded-full blur-3xl animate-float"
					...
					<div className="flex flex-col items-center space-y-8 text-center">
						...
						<div className="space-y-4 max-w-4xl">
							...
							<p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">
								Transformamos ideas en experiencias digitales excepcionales. Desarrollo web, diseño
								UX/UI y soluciones tecnológicas a medida para hacer crecer tu empresa.
							</p>
						</div>
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<Button
								asChild
								size="lg"
								className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 text-white group"
							>
								<Link href="/contacto">
									Comenzar Proyecto
							...
							<Button
								...
								variant="outline"
								size="lg"
								className="border-2 hover:bg-muted hover:scale-105 transition-all duration-300"
							>
					...
					<ScrollReveal direction="fade" delay={100}>
						<div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
							<div className="flex flex-col items-center text-center space-y-2 neumorphic-card p-6 hover:neumorphic-glow">
								...
								<p className="text-xs sm:text-sm text-muted-foreground">Proyectos Completados</p>
							</div>
							...
							<div className="flex flex-col items-center text-center space-y-2 neumorphic-card p-6 hover:neumorphic-glow">
								...
								<p className="text-xs sm:text-sm text-muted-foreground">Tasa de Satisfacción</p>
							</div>
						</div>
					</ScrollReveal>
				</div>
					...
					<ScrollReveal direction="up" delay={100}>
						<div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
							...
							<p className="max-w-[900px] text-muted-foreground md:text-xl">
								Ofrecemos un ecosistema completo de servicios digitales para impulsar tu negocio
							</p>
						</div>
					</ScrollReveal>
						...
						<ScrollReveal direction="up" delay={300}>
							<Card className="group neumorphic-gradient border-0 relative overflow-hidden">
								...
								<CardHeader className="relative">
									...
									<CardDescription className="text-base">
										Experiencias de usuario excepcionales y diseños que convierten
									</CardDescription>
								</CardHeader>
								<CardContent>
									<ul className="space-y-2 text-sm text-muted-foreground">
				...
				<div className="container px-4 md:px-6">
					<ScrollReveal direction="up" delay={100}>
						<div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
							...
							<p className="max-w-[900px] text-muted-foreground md:text-xl">
								Algunos de mis proyectos más recientes disponibles en GitHub
							</p>
						</div>
					</ScrollReveal>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
						<ScrollReveal direction="up" delay={200}>
							<Card className="group overflow-hidden neumorphic-card border-0 hover:shadow-2xl transition-all duration-500">
								<div className="aspect-video relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
									...
									<div className="absolute top-4 left-4 z-10">
										<Badge className="bg-white/90 text-blue-700 backdrop-blur shadow-lg">
											Agencia Web
										</Badge>
									</div>
								</div>
								<CardHeader>
									<CardTitle>Agencia TecnoDespegue</CardTitle>
									<CardDescription>
										Sitio web profesional con diseño moderno y sistema neumórfico
									</CardDescription>
								</CardHeader>
							</Card>
						</ScrollReveal>
						...
						<ScrollReveal direction="up" delay={300}>
							<Card className="group overflow-hidden neumorphic-card border-0 hover:shadow-2xl transition-all duration-500">
								<div className="aspect-video relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
									...
									<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
									<div className="absolute top-4 left-4 z-10">
										<Badge className="bg-white/90 text-purple-700 backdrop-blur shadow-lg">
											E-commerce
										</Badge>
									</div>
								</div>
								<CardHeader>
									<CardTitle>E-commerce FullStack</CardTitle>
									<CardDescription>
										Tienda online completa con carrito de compras y panel de admin
									</CardDescription>
								</CardHeader>
							</Card>
						</ScrollReveal>
						...
						<ScrollReveal direction="up" delay={400}>
							<Card className="group overflow-hidden neumorphic-card border-0 hover:shadow-2xl transition-all duration-500">
								<div className="aspect-video relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
									...
									<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
									<div className="absolute top-4 left-4 z-10">
										<Badge className="bg-white/90 text-green-700 backdrop-blur shadow-lg">
											Dashboard
										</Badge>
									</div>
								</div>
								<CardHeader>
									<CardTitle>Dashboard Profesional</CardTitle>
									<CardDescription>
										Dashboard empresarial con gráficos interactivos y métricas
									</CardDescription>
								</CardHeader>
							</Card>
						</ScrollReveal>
			...
			{/* Tech Carousel Section - Replaced Testimonials */}
			<TechCarousel />
				...
				<div className="container px-4 md:px-6 relative">
					<div className="flex flex-col items-center justify-center space-y-6 text-center text-white">
						...
						<p className="mx-auto max-w-[600px] text-white/90 text-lg md:text-xl">
							Transforma tu visión en realidad. Contáctanos hoy y descubre cómo podemos llevar tu
